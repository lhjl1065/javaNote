    ...
    <form action="${pageContext.request.contextPath}/updateServlet" method="post">
        ...
        <div class="form-group">
            <c:if test="${user.address=='广东'}">
                ...
                <select name="address" class="form-control" value="${user.address}" id="address">
            ...
            <c:if test="${user.address=='贵阳'}">
                <label for="address">籍贯：</label>
                <select name="address" class="form-control" value="${user.address}" id="address">
                    <option value="广东">广东</option>
                    <option value="广西">广西</option>
                    <option value="湖南">湖南</option>
                    <option value="贵阳" selected>贵阳</option>
                    <option value="沈阳">沈阳</option>
                    <option value="北京">北京</option>
                </select>
            </c:if>
            <c:if test="${user.address=='沈阳'}">
                <label for="address">籍贯：</label>
                <select name="address" class="form-control" value="${user.address}" id="address">
                    <option value="广东">广东</option>
                    <option value="广西">广西</option>
                    <option value="湖南">湖南</option>
                    <option value="贵阳">贵阳</option>
                    <option value="沈阳" selected>沈阳</option>
                    <option value="北京">北京</option>
                </select>
            </c:if>
